...
export declare type LegacyDocumentActionColor = 'primary' | 'success' | 'warning' | 'danger';
...
export declare type DocumentActionDialogProps = DocumentActionLegacyDialogProps | DocumentActionConfirmDialogProps | DocumentActionPopoverDialogProps | DocumentActionModalDialogProps | DocumentActionErrorDialogProps | DocumentActionSuccessDialogProps;
