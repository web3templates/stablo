...
export default class DefaultTextArea extends React.Component<DefaultTextAreaProps & Omit<React.HTMLProps<HTMLTextAreaElement>, 'id'>> {
...
export {};
//# sourceMappingURL=DefaultTextArea.d.ts.map