...
export default function createButtonLike(as: ButtonComponent | 'button' | 'a', { displayName, defaultProps }: ButtonComponentOpts): {
    new (props: ButtonProps | Readonly<ButtonProps>): {
        ...
        render(): JSX.Element;
        context: any;
        setState<K extends "focusSetFromOutside">(state: ButtonState | ((prevState: Readonly<ButtonState>, props: Readonly<ButtonProps>) => ButtonState | Pick<ButtonState, K>) | Pick<ButtonState, K>, callback?: () => void): void;
...
export {};
//# sourceMappingURL=createButtonLike.d.ts.map