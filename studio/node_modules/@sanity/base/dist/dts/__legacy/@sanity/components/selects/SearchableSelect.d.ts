...
export default class SearchableSelect extends React.PureComponent<SearchableSelectProps & Omit<React.HTMLProps<HTMLInputElement>, 'onChange' | 'onFocus' | 'value'>, State> {
    static defaultProps: {
        placeholder: string;
        isLoading: boolean;
        onChange: () => any;
