...
const schemes = {
  light: [import_color.hues.red[200].hex, import_color.hues.red[300].hex, import_color.hues.red[500].hex],
  dark: [import_color.hues.gray[500].hex, import_color.hues.gray[300].hex, import_color.white.hex]
};
const SanityLogo = (0, import_react.forwardRef)(function SanityLogo2(props, ref) {
  const scheme = schemes[props.dark ? "dark" : "light"];
  return /* @__PURE__ */ import_react.default.createElement("svg", __spreadProps(__spreadValues({
