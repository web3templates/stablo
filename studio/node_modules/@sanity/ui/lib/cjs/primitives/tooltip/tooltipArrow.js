...
`;
const Border = import_styled_components.default.path`
  fill: var(--card-shadow-outline-color);
`;
const Shape = import_styled_components.default.path`
  fill: var(--card-bg-color);
`;
const TooltipArrow = (0, import_react.forwardRef)(function TooltipArrow2(props, ref) {
  ...
  return /* @__PURE__ */ import_react.default.createElement(Root, __spreadProps(__spreadValues({}, restProps), {
    ...
    height: "15",
    viewBox: "0 0 15 15"
  }, /* @__PURE__ */ import_react.default.createElement(Border, {
