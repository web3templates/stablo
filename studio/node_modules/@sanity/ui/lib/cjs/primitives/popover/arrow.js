...
`;
const BorderPath = import_styled_components.default.path`
  fill: var(--card-shadow-outline-color);
`;
const ShapePath = import_styled_components.default.path`
  fill: var(--card-bg-color);
`;
const PopoverArrow = (0, import_react.forwardRef)(function PopoverArrow2(props, ref) {
  ...
  }, /* @__PURE__ */ import_react.default.createElement(BorderPath, {
  ...
  }), /* @__PURE__ */ import_react.default.createElement(ShapePath, {
