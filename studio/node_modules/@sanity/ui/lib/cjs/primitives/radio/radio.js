...
const Root = import_styled_components.default.div(import_styles.radioBaseStyle);
const Input = import_styled_components.default.input(import_styles.inputElementStyle);
const Radio = (0, import_react.forwardRef)(function Radio2(props, forwardedRef) {
