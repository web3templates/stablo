...
var import_code = __toModule(require("../code"));
function kbdStyle() {
...
const Root = import_styled_components.default.kbd(import_internal.responsiveRadiusStyle, kbdStyle);
const KBD = (0, import_react.forwardRef)(function KBD2(props, ref) {
  ...
  return /* @__PURE__ */ import_react.default.createElement(Root, __spreadProps(__spreadValues({
    ...
    $radius: radius,
    ref
  }), /* @__PURE__ */ import_react.default.createElement(import_box.Box, {
    as: "span",
    padding
  }, /* @__PURE__ */ import_react.default.createElement(import_code.Code, {
    as: "span",
    muted: true,
    size: fontSize
  }, children)));
