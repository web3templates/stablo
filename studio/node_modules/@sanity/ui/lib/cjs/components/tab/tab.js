...
const Tab = (0, import_react.forwardRef)(function Tab2(props, forwardedRef) {
  const _a = props, {
    icon,
    id,
    focused,
  ...
  return /* @__PURE__ */ import_react.default.createElement(import_primitives.Button, __spreadProps(__spreadValues({
    "data-ui": "Tab"
  }, restProps), {
