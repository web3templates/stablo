...
import { ArraySchemaType, BooleanSchemaType, StringSchemaType, NumberSchemaType, ObjectSchemaType, ReferenceSchemaType } from '../diff';
export declare type PreviewComponent<T> = ComponentType<{
    color?: UserColor;
